...
function movePlayers() {
  ...
  // Update shield status – now each player's shield is toggled directly via its key (q for Player1, m for Player2)
...
function drawTopStatus() {
  ...
  ctx.textAlign = "left";
  ctx.fillStyle = "white";
  ctx.fillText("Health: " + player1.health + "%", leftX + 5, topY + 18);
  ...
  ctx.fillStyle = "white";
  ctx.fillText("Shield: " + player1.shield + "% 🛡️", leftX + 5, topY + (barHeight * 2) + 10);
  
  // Draw a border around health/shield if shield is active
  ...
  ctx.fillStyle = "white";
  ctx.fillText("Health: " + player2.health + "%", rightX + barWidth - 5, topY + 18);
  ...
  ctx.fillStyle = "white";
  ctx.fillText("Shield: " + player2.shield + "% 🛡️", rightX + barWidth - 5, topY + (barHeight * 2) + 10);
  ...
  // --- Player Names (Removed white boxes; names appear centered below shield bars) ---
  ctx.font = "bold 18px Arial";
  ctx.textAlign = "center";
  ctx.fillStyle = "blue";
  ctx.fillText("🟦 " + p1Name, leftX + barWidth / 2, topY + (barHeight * 2) + 40);
  ctx.fillStyle = "red";
  ctx.fillText("🟥 " + p2Name, rightX + barWidth / 2, topY + (barHeight * 2) + 40);
